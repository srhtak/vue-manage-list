...
<template>
  <a class="w-full" href="/products/basic-tee">
    <div
      class="shadow-[0_4px_0_0_rgba(0,0,0,1)] border-2 border-black rounded-3xl overflow-hidden"
    >
      <img
    ...
    <div class="relative pt-4">
      ...
      <p class="mt-2">
        ...
        <span class="font-medium tracking-wider"> £24.00 GBP </span>
      </p>
    </div>
  </a>
</template>
